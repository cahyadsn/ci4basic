...
namespace cahyadsn\ci4basic\Commands;
...
class PublishCommand extends BaseCommand
{
    ...
    /**
     * The path to cahyadsn\ci4basic\src directory.
     *
     * @var string
     */
    ...
    protected function publishConfig()
    {
        ...
        $content = str_replace('namespace cahyadsn\ci4basic\Config', 'namespace Config', $content);
    ...
    protected function publishMigration()
    {
        ...
        foreach ($map as $file) {
            ...
            $content = str_replace('namespace cahyadsn\ci4basic\Database\Migrations', 'namespace '.APP_NAMESPACE.'\Database\Migrations', $content);
