<!-- Include -->
<?= $this->include('cahyadsn\ci4basic\Views\load\nestable') ?>
<?= $this->include('cahyadsn\ci4basic\Views\load\select2') ?>
<?= $this->include('cahyadsn\ci4basic\Views\load\iconpicker') ?>
<!-- Extend from layout index -->
<?= $this->extend('cahyadsn\ci4basic\Views\layout\index') ?>

<!-- Section content -->
<?= $this->section('content') ?>
    <?= $this->include('cahyadsn\ci4basic\Views\Menu\update') ?>
