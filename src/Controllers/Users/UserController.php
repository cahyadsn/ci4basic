...
namespace cahyadsn\ci4basic\Controllers\Users;

use cahyadsn\ci4basic\Controllers\BaseController;
use cahyadsn\ci4basic\Entities\Collection;
...
class UserController extends BaseController
{
    ...
    /** @var \cahyadsn\ci4basic\Models\UserModel */
    protected $users;
    ...
    public function index()
    {
        ...
        return view('cahyadsn\ci4basic\Views\User\index', [
    ...
    public function profile()
    {
        ...
        return view('cahyadsn\ci4basic\Views\User\profile', [
    ...
    public function new()
    {
        return view('cahyadsn\ci4basic\Views\User\create', [
            'title'       => lang('boilerplate.user.title'),
    ...
    public function edit($id)
    {
        ...
        return view('cahyadsn\ci4basic\Views\User\update', $data);
    }
